...
class Entity:
    ...
    def move_towards(self, target_x, target_y, game_map, entities):
        ...
        # Normalises the distance to a 'unit vector' of 1 tile.
        # (It scales the hypotenuse to 1 by dividing it by its own distance then also
        # dividing the other two sides by that distance.)
        # See khan academy at "https://goo.gl/DCY0ZZ" for more information.
        dx = int(round(dx / distance))
        dy = int(round(dy / distance))
        # Moves if the next tile is not blocked by a tile or another entity.
